...
#model selection ({{'max_features': 17, 'min_samples_leaf': 1})
params = {
...
#train algorithm
model = RandomForestClassifier(min_samples_leaf = clf.best_params_['min_samples_leaf'], max_features = clf.best_params_['max_features'])
...
#model evaluation using cross validation (score = 0.8133065347351061)
model = RandomForestClassifier(min_samples_leaf = clf.best_params_['min_samples_leaf'], max_features = clf.best_params_['max_features'])
